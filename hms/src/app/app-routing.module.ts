...
import { PatloginComponent } from './patlogin/patlogin.component';
import { PatdashComponent } from './patdash/patdash.component';
const routes: Routes = [
  ...
  {
    path:'patlogin',component:PatloginComponent
  },
  {
    path:'patdash',component:PatdashComponent
  }
